...
public class RuntimeAlertRequest {
	...
	public static RuntimeAlertRequest factory(String type) throws AppException {
	...
	private void setCPUUsageAlert() throws AppException {
		this.name = String.format("[%s] CPU usage threshold exceeded alert", Const.ENV_NAME);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type", "email");
		action.put("subject", String.format("[%s] ${severity}: CPU usage ${state}", Const.ENV_NAME));
		action.put("content",
		...
		action.put("userIds", findRecipients());
	...
	private void setDeployfailedAlert() throws AppException {
		this.name = String.format("[%s] Deploy failed alert", Const.ENV_NAME);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type", "email");
		action.put("subject", String.format("[%s] ${severity}: Deployment Failed", Const.ENV_NAME));
		action.put("content",
	...
	private void setMemoryUsageAlert() throws AppException {
		this.name = String.format("[%s] Memory usage threshold exceeded alert", Const.ENV_NAME);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type", "email");
		action.put("subject", String.format("[%s] ${severity}: memory usage ${state}", Const.ENV_NAME));
		action.put("content",
	...
	private void setWorkerNotRespondingAlert() throws AppException {
		this.name = String.format("[%s] Worker not responding alert", Const.ENV_NAME);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type", "email");
		action.put("subject", String.format("[%s] ${severity}: Worker unresponsive", Const.ENV_NAME));
		action.put("content",
	...
	private void setCustomApplicationNortificationAlert() throws AppException {
		this.name = String.format("[%s] Custom application nortification alert", Const.ENV_NAME);
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type", "email");
		action.put("subject", String.format("[%s] ${severity}: Custom Application Notification", Const.ENV_NAME));
		action.put("content",
	...
	private void setExceedEventTrafficThreshholdAlert() throws AppException {
		this.name = String.format("[%s] Event traffic threshold exceeded alert", Const.ENV_NAME);
		// this.severity = "CRITICAL";
		Map<String, Object> action = new HashMap<String, Object>();
		action.put("type", "email");
		action.put("subject", String.format("[%s] ${severity}: Event Threshold Exceeded", Const.ENV_NAME));
		action.put("content",
	...
	private List<String> findRecipients() throws AppException {
		List<String> userIds = new ArrayList<String>();
		for (String username : Const.ALERT_RECIPIENTS) {
			AccessManagementAPICaller caller = new AccessManagementAPICaller();
			Map<String, Object> user = null;
			user = caller.findMember(username);
